...
public class SparseEnumIntMapTest
{
    private static final int UNUSED_VALUE = -42;

    private SparseEnumIntMap<TestEnum> mMap;

    @Before
    public void setUp()
    {
        mMap = new SparseEnumIntMap<>(TestEnum.class);
    }
    ...
    public void testGet()
    {
        Assert.assertEquals(TestEnum.VALUE_1, mMap.get(TestEnum.VALUE_1.toInt()));
    }
